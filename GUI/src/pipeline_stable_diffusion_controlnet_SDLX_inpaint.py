...
class StableDiffusionControlNetInpaintPipeline(StableDiffusionXLControlNetPipeline):
    r"""
    ...
    def __call__(
        ...
        def _default_height_width(height, width, image):
            ...
            return height, width
        height, width = _default_height_width(height, width, control_image)

        # 1. Check inputs. Raise error if not correct
        self.check_inputs(
            prompt,None, control_image, callback_steps, negative_prompt,None, prompt_embeds, negative_prompt_embeds
        )
